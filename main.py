...
FEED_URLS = [
    ...
    "https://news.google.com/rss/search?q=%E0%A6%AC%E0%A6%BE%E0%A6%82%E0%A6%B2%E0%A6%BE%E0%A6%A6%E0%A7%87%E0%A6%B6+%E0%A6%85%E0%A6%B0%E0%A7%8D%E0%A6%A5%E0%A6%A8%E0%A7%80%E0%A6%A4%E0%A6%BF+OR+%E0%A6%AC%E0%A6%BE%E0%A6%9C%E0%A7%87%E0%A6%9F+OR+%E0%A6%B0%E0%A6%BE%E0%A6%9C%E0%A6%B8%E0%A7%8D%E0%A6%AC+OR+%E0%A6%8F%E0%A6%A8%E0%A6%AC%E0%A6%BF%E0%A6%86%E0%A6%B0+OR+%E0%A6%AE%E0%A7%82%E0%A6%B2%E0%A7%8D%E0%A6%AF%E0%A6%AC%E0%A7%80%E0%A6%A4%E0%A6%BF+when:7d&hl=bn-BD&gl=BD&ceid=BD:bn",
    ...
    "https://news.google.com/rss/search?q=%E0%A6%AC%E0%A6%BE%E0%A6%82%E0%A6%B2%E0%A6%BE%E0%A6%A6%E0%A7%87%E0%A6%B6+%E0%A6%AC%E0%A6%BF%E0%A6%A8%E0%A6%BF%E0%A6%AF%E0%A6%BC%E0%A7%8B%E0%A6%97+OR+%E0%A6%B0%E0%A6%AA%E0%A7%8D%E0%A6%A4%E0%A6%BE%E0%A6%A8%E0%A6%BF+OR+%E0%A6%86%E0%A6%AE%E0%A6%A6%E0%A6%BE%E0%A6%A8%E0%A6%BF+OR+%E0%A6%B0%E0%A7%87%E0%A6%AE%E0%A6%BF%E0%A6%9C%E0%A6%BC%E0%A6%BE%E0%A6%B8%E0%A7%8D%E0%A7%8D%E0%A0%B8+OR+%E0%A6%AA%E0%A7%8B%E0%A6%B6%E0%A6%BE%E0%A6%95+OR+%E0%A6%B6%E0%A6%BF%E0%A6%B2%E0%A7%8D%E0%A6%AA+when:7d&hl=bn-BD&gl=BD&ceid=BD:bn",
...
PROMPT = """You are a strict news classifier for Bangladesh macroeconomics and finance.
Output must be valid JSON only — no markdown, no explanation, no preamble.

TASK: Identify 0-based indices of SIGNAL articles from the list below. Strictly exclude NOISE. Strictly deduplicate near-identical coverage of the same event.

SIGNAL — include if the headline concerns Bangladesh and touches:
1. Central Bank & Monetary Policy: Bangladesh Bank rates, repo, CRR/SLR, money supply, banking rules.
2. Currency & Reserves: Taka-USD exchange rate, forex reserves, BB market interventions.
3. External Sector: Remittances, exports/imports, RMG/garments, trade deficit, balance of payments.
4. Fiscal Policy & Tax: National budget, NBR revenue, customs, VAT, public debt, government bonds.
5. Macro Indicators: GDP, CPI, inflation index, foreign debt, IMF/World Bank/ADB loans or reviews.
6. Capital Markets: DSE/CSE indices, BSEC regulations, systemic banking health (NPLs, liquidity).
7. Energy & Industrial Policy: Fuel/gas/electricity tariff changes, BIDA/BEPZA/EPZ investment policy.
8. Expert Macro Analysis: National economic forecasts, trade policy analysis, macro outlooks.

NOISE — strictly exclude:
- Single company news: product launches, branch openings, awards, promotions.
- Local retail price shifts not tied to a government policy or tariff action.
- Sports, entertainment, crime, accidents, political speeches without economic implication.
- Global news with no direct fiscal or operational impact on Bangladesh.

DEDUPLICATION (strictly enforced):
When multiple headlines cover the same event — including the same story in English and Bengali, or from two outlets — keep ONLY ONE index. Prefer the clearer or more detailed headline.
...
2. স্কয়ার ফার্মাসিউটিক্যালস সিলেটে নতুন সেলস সেন্টার খুলেছে
3. Bangladesh's forex reserves cross $20 billion amid remittance surge
4. রেমিট্যান্সের চাপে রিজার্ভ ২০ বিলিয়ন ডলার ছাড়াল
5. সাকিব আল হাসান নতুন ব্র্যান্ড অ্যাম্বাসেডর
...
6. আগস্টে মূল্যস্ফীতি ৯.২ শতাংশে নেমেছে
...
def fetch_all_feeds():
    ...
    for a in all_articles:
        included_sources[a["source"]] = (
            included_sources.get(a["source"], 0) + 1
        )
...
def _load_or_create(output_file, feed_title, feed_description):
    ...
    if Path(output_file).exists():
        try:
            ...
            print(
                "[INFO] Retrying with sanitized content…"
            )
        ...
        try:
            ...
            if channel is not None:
                ...
                print(
                    "[INFO] Sanitization succeeded — "
                    f"recovered {recovered} existing item(s)."
                )
...
def main():
    ...
    print(
        ...
        "to Mistral for BD economics/finance filtering…"
    )
    ...
    if signal_articles:
        ...
        print(
            "Mistral returned no signal indices for main feed."
        )
