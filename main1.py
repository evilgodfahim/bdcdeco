...
FEED_URLS = [
    ...
    "https://news.google.com/rss/search?q=Bangladesh+budget+OR+revenue+OR+NBR+OR+tax+OR+export+OR+import+OR+%22trade+deficit%22+when:7d&hl=en-BD&gl=BD&ceid=BD:en",
...
def main():
    ...
    gemini_indices = send_to_mistral(
        new_articles
    )
