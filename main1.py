...
FEED_URLS = [
    ...
    "https://news.google.com/rss/search?q=%E0%A6%AC%E0%A6%BE%E0%A6%82%E0%A6%B2%E0%A6%BE%E0%A6%A6%E0%A7%87%E0%A6%B6+%E0%A6%86%E0%A6%87%E0%A6%8F%E0%A6%AE%E0%A6%8F%E0%A6%AB+OR+%E0%A6%AC%E0%A6%BF%E0%A6%B6%E0%A7%8D%E0%A6%AC%E0%A6%AC%E0%A7%8D%E0%A6%AF%E0%A6%BE%E0%A6%82%E0%A6%95+OR+%E0%A6%8B%E0%A6%A3+OR+%E0%A6%B0%E0%A6%িজার্ভ+OR+%E0%A6%AC%E0%A7%88%E0%A6%A6%E0%A7%87%E0%A6%B6%E0%A6%BF%E0%A6%95+%E0%A6%B8%E0%A6%BE%E0%A6%B9%E0%A6%BE%E0%A6%AF%E0%A7%8D%E0%A6%AF+when:7d&hl=bn-BD&gl=BD&ceid=BD:bn",
]
...
def decode_google_news_url(gnews_url: str, _retries: int = 3) -> str:
    ...
    Supports both:
      - googlenewsdecoder >= 0.2.1 -> gnewsdecoder()
      - googlenewsdecoder <= 0.1.7 -> new_decoderv1()

    Returns the original Google News URL if decoding fails.
    """
    ...
    for url in FEED_URLS:
        ...
        for e in feed.entries:
            ...
            if is_google_news_url(raw_link):
                real_link = decode_google_news_url(
                    raw_link
                )
            else:
                real_link = raw_link
...
def _load_or_create(
    ...
    if Path(output_file).exists():
        ...
        try:
            ...
            print(
                f"[WARN] XML still unparseable "
                f"after sanitization "
                f"({output_file}): {e}"
            )

            print(
                "[WARN] Starting a fresh feed — "
                "existing items in this file "
                "cannot be recovered."
            )
...
def main():
    ...
    print(
        f"Sending {len(new_articles)} "
        "article(s) to Gemini for "
        "BD economics/finance filtering…"
    )

    gemini_indices = send_to_gemini(
        new_articles
    )
    ...
    if not gemini_indices:
        print(
            "Gemini returned 0 signal "
            "articles. No files written."
        )
